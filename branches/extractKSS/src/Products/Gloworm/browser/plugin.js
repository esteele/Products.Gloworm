...
kukit.actionsGlobalRegistry.register('initializeClouseauSession', function() {
...
kukit.commandsGlobalRegistry.registerFromAction('initializeClouseauSession', kukit.cr.makeGlobalCommand);
